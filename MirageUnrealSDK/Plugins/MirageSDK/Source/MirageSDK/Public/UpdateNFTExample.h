...
//#endif /* DOXYGEN_SHOULD_SKIP_THIS */
	...
	/// ~~~~~~~~~~~~~~~~~~~~~~~
	UFUNCTION(BlueprintCallable, Category = "MIRAGE SDK")
	void UpdateNFT(FString abi_hash, FItemInfoStructure _item, FMirageCallCompleteDynamicDelegate Result);

	/// GetUpdateNFTResult function is used to get the result of the ticket generated by UpdateNFT(FString, FItemInfoStructure, FMirageCallCompleteDynamicDelegate);
	///
