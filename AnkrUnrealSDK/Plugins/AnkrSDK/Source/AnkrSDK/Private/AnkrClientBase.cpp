...
void UAnkrClientBase::SendRequest(FString _url, FString _verb, FString _payload, TFunctionRef<void(const TArray<uint8>, const FString, const FAdvertisementReceivedDelegate&, TSharedPtr<FJsonObject>)> _function, const FAdvertisementReceivedDelegate& _callback, bool _backgroundTask)
{
	FHttpModule* httpModule = &FHttpModule::Get();
...
void UAnkrClientBase::SendRequest(FString _url, TFunctionRef<void(const TArray<uint8>, const FString, FAdvertisementDataStructure data, const FAdvertisementVideoAdDownloadDelegate&)> _function, FAdvertisementDataStructure data, const FAdvertisementVideoAdDownloadDelegate& _callback, bool _backgroundTask)
{
	FHttpModule* httpModule = &FHttpModule::Get();
