...
//#endif /* DOXYGEN_SHOULD_SKIP_THIS */
	...
	///
	/// The function requires a parameter described below and returns nothing.\n
	/// Inside the function, A POST request is sent to the Ankr API. The request needs a json body containing a device id and the format is described in the body section below.\n
	/// string data will be received in json response for "login", "session" and "uri".\n
	/// "uri" will be used to launch metamask to confirm the user to connect wallet. Once connected you can call GetWalletInfo(const FAnkrCallCompleteDynamicDelegate&) to get the wallet address.
	///
	...
	///
	/// The function requires a parameter described below and returns nothing.\n
	/// Inside the function, A POST request is sent to the Ankr API. The request needs a json body containing an abi string and the format is described in the body section below.\n
	...
	///
	/// The function requires parameters described below and returns nothing.\n
	/// Inside the function, A POST request is sent to the Ankr API. The request needs a json body containing a device_id and message. The format is described in the body section below.\n
	/// string data will be received in json response for a "data".
	///
	...
	///
	/// @param ticket The ticket received from the SignMessage(FString, const FAnkrCallCompleteDynamicDelegate&) function.
	/// @param Result A callback delegate that will be triggered once a response is received with data.
	/// 
	/// ### Body
	/// ~~~~~~~~~~~~~~~~~~~~~~~.cpp
	...
	///
	/// The function requires parameters described below and returns nothing.\n
	/// Inside the function, A POST request is sent to the Ankr API. The request needs a json body containing a device_id, message and signature. The format is described in the body section below.\n
